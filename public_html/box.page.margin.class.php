...
class BoxPageMargin extends GenericContainerBox {
   ...
   */
  static function create(&$pipeline, $at_rule) {
  ...
  function reflowMarginBoxes(&$driver, &$media, $boxes) {
    $context = new FlowContext;
    $this->_position($media, $boxes, $context);

    $this->setCSSProperty(CSS_WIDTH, new WCConstant($this->get_width()));
    $constraint = new HCConstraint(array($this->height, false),
        null,
        null);
    $this->put_height_constraint($constraint);
